...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // if screen is large then show the side menu and make offset for main content, initially
    if(isLargeScreen){
    ...
    menuToggleButton.addEventListener('click', function () {
        ...
        if(isLargeScreen){
            //make/un-make offset for main-content due to side menu appearing(for larger screens)
